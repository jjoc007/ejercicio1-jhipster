...
import co.edu.udistrital.software.broadcast.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link co.edu.udistrital.software.broadcast.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
